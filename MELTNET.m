function Y = MELTNET(X,DAEnet,SEGnet,options)
...
arguments
    ...
    SEGnet.params struct % weights and biases from trained segmentation net
    SEGnet.state struct % normalization states from trained segmentation net
...
[~, ~, ~,segnetY] = dlfeval(@lossMELTNET_SEG, SEGnet.params, X, [], options.nClasses,SEGnet.state,false,[]);
